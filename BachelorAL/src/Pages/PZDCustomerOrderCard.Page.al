page 50113 "PZD Customer Order Card"
{
        ...
        area(Processing)
        {
            ...
            action("Close Order")
            {
                ...
                begin
                    ...
                    Rec."Consultant ID" := UserSetup."User ID";
                end;
            }
            ...
            action("Generate Contract")
            {
                ...
                trigger OnAction()
                var
                    CustomerOrderContract: Report "PZD Customer Order Contract";
                begin
                    CustomerOrderContract.SetTableView(Rec);
                    CustomerOrderContract.Run();
                end;
            }
        }
    }
